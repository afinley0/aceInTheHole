...
<body>
    ...
    <main>
        <h1>Registration</h1>
        <div class="forms">
            <p>If you are planning to registers as both an athlete and a volunteer, please fill out two forms.
                One for each option.</p>
            <p>Splash n' Dash is open to children ages 4 to 15. It is a free event for kids, if an adult registers for an event.
